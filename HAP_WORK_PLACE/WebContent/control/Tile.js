...
sap.ui.define(['jquery.sap.global', 'sap/m/library', 'sap/ui/core/Control'],
	 ...
	 */
	var Tile = Control.extend("hapwp.control.Tile", /** @lends sap.m.Tile.prototype */ { metadata : {
	...
	Tile.prototype.onAfterRendering = function(){
		if (this._rendered && !this._bIsDragged && this.getParent() instanceof hapwp.control.TileContainer) {
	...
	Tile.prototype._getTileIndex = function() {
		var oTileContainer = this.getParent(),
			iTileIndex = null;
		if (oTileContainer && oTileContainer instanceof hapwp.control.TileContainer) {
